...
public class Ex1 {
    ...
    private static AutomovelPesadoMercadorias pesado1 = new AutomovelPesadoMercadorias("11-11-AA", "Fiat", "Palio", 150, 1, 2.0f, 10.0f);
    private static AutomovelPesadoPassageiros pesado2 = new AutomovelPesadoPassageiros("44-44-64", "Volvo", "PS-C", 150, 1, 2.0f, 50);
    ...
    private static AutomovelLigeiro ligeiro1 = new AutomovelLigeiro("12-34-85", "Mercedes", "NS", 150, 1, 7.0f);
    private static Taxi ligeiro2 = new Taxi("12-34-5Z", "Mercedes", "NS", 150, 1, 123442);
    private static AutomovelLigeiroEletrico eletrico1 = new AutomovelLigeiroEletrico("12-34-N5", "Mercedes", "NS", 150, 1, 7.0f, 100);
