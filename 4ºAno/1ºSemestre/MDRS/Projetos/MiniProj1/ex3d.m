...
for k = 1:length(n)
    ...
    for i = 1:N
        [PLdata(i), PLvoip(i), APDdata(i), APDvoip(i)] = Sim4A(lambda, C, f, P, n(k),p);
    end
...
% what shows:
% no voip packet loss
% data packets delay high and going higher as the voip flows increase
% voip packets delay minimal increase
% data packet loss significally increasing as the voip flows increase
