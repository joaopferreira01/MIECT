...
public class aglv2Lexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__33", "T__34", "T__35", "T__36", "T__37", "T__38", "Boolean", "ID", 
			"Number", "String", "COMMENT", "MLCOMMENT", "WS", "NL"
		};
	}
	...
	public aglv2Lexer(CharStream input) {
		super(input);
