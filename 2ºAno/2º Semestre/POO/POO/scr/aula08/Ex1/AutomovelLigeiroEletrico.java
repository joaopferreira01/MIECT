...
public class AutomovelLigeiroEletrico extends AutomovelLigeiro implements VeiculoEletrico {
    ...
    public AutomovelLigeiroEletrico(String matricula, String marca, String modelo, int potencia, int numero_do_quadro, float capacidade_bagageira, int autonomia_max) {
